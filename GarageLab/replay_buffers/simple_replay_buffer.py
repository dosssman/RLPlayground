...
class SimpleReplayBuffer( object):
    ...
    def __init__( self, env_spec, max_size = 10000, batch_size = 128):
        self._env_spec = env_spec # Might want to remove this for memory efficiency
        ...
        self._Do = self._env_spec.observation_space.shape
        self._Da = self._env_spec.action_space.shape
    ...
    def add_transition( self, observation, action, reward, terminal, next_observation):
        ...
        self._next_observations[self._current_index] = next_observation
